...
public class CoralIntakeSubsystem extends IronSubsystem {
  ...
  private final TalonFX primaryIntakeMotor = new TalonFX(
    CORAL_INTAKE_MOTOR_LEFT
  );
  ...
  public CoralIntakeSubsystem() {
    ...
    rightIntake.setControl(
      new Follower(
        CORAL_INTAKE_MOTOR_LEFT,
        !primaryConfiguration.MotorOutput.Inverted.equals(
          CORAL_INTAKE_MOTOR_RIGHT_INVERSION
        )
      )
    ); //TODO maybe make seperate function to check this
    rollerIntake.setControl(
      new Follower(
        CORAL_INTAKE_MOTOR_LEFT,
        !primaryConfiguration.MotorOutput.Inverted.equals(
          CORAL_INTAKE_MOTOR_RIGHT_INVERSION
  ...
  public void periodic() {
    publish(
      "Velocity",
      primaryIntakeMotor.getVelocity().getValue().in(Units.DegreesPerSecond)
    );
